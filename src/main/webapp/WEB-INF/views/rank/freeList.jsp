...
<body>
<h1 id="h1" style="text-align: center; margin-top: 100px;">자유게시판</h1>
<table class="table table-hover" id="list_table">
	...
	<c:forEach  var="board"  items="${freeList}">
		<tr>
			<td>${board.id_num}</td>
			<td>${board.name} </td>
			<td><a href="freeView?id_num=${board.id_num}&current_page=${current_page}&searchStr=">${board.subject}</a></td>
